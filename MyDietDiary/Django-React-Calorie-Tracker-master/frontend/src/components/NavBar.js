...
const NavBar = () => {
    ...
    return (
        ...
        <Navbar variant="light" style={{fontFamily:'Arial,sans-serif'}}>
            ...
            <>
                <Navbar.Brand href="/"><a href = "/" style={{position: 'absolute',marginLeft:'100px',marginTop:'7px',textDecoration: 'none',fontSize: '1.5em',fontWeight: 'bold', textTransform: 'uppercase',letterSpacing: '2px',transition: '0.4s', animation: 'fadein1 2s', transform: 'translate(0,0)'}}>MYDIETDIARY</a></Navbar.Brand>
                <Nav.Link className="text-dark" href="http://localhost:8000/"><Button  style={{right:'250px',marginTop:'7px',position: 'absolute', backgroundColor: '#FFC107', border:'none', color:'black',fontSize:'20px'}}>Home</Button> </Nav.Link>
            ...
            <>
                <Navbar.Brand href="/"><a href= "/" style={{position: 'absolute',marginLeft:'100px',marginTop:'7px',textDecoration: 'none',fontSize: '1.5em',fontWeight: 'bold', textTransform: 'uppercase',letterSpacing: '2px',transition: '0.4s', animation: 'fadein1 2s', transform: 'translate(0,0)'}}>MYDIETDIARY</a></Navbar.Brand>
                <Nav.Link className="text-dark" href="/"><Button  style={{right:'400px',marginTop:'7px',position: 'absolute', backgroundColor: '#FFC107', border:'none', color:'black',fontSize:'20px'}}>Home</Button> </Nav.Link>
